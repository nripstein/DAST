...
- [`plot(`*`<disag_data_mmap>`*`)`](http://noahripstein.com/DAST/reference/plot.disag_data_mmap.md)
  : Visual summary plot of prepared data
- [`plot_aggregation_raster()`](http://noahripstein.com/DAST/reference/plot_aggregation_raster.md)
  : Plot the offset raster
- [`plot_covariate_raster()`](http://noahripstein.com/DAST/reference/plot_covariate_raster.md)
  : Plot a single covariate raster
- [`plot_mesh()`](http://noahripstein.com/DAST/reference/plot_mesh.md) :
  Plot the SPDE mesh with custom outer/inner boundaries
- [`plot_polygons()`](http://noahripstein.com/DAST/reference/plot_polygons.md)
...
- [`print(`*`<disag_data_mmap>`*`)`](http://noahripstein.com/DAST/reference/print.disag_data_mmap.md)
