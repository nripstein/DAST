...
This vignette builds a small synthetic example for the multiple-map setting.
Two sets of administrative regions cover the same unit-square domain, but the
...
The two maps below reuse the geometry from the schematic figure. Map 1 has four
rectangular regions. Map 2 redraws the boundaries into five regions.
